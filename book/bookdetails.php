  ...
  <div class="content">
      ...
      <h2> 
        by <?php //Look at this later, remember to update the db
            ...
            echo "<a href='search/searchresults.php?author=$author_id'>$row[author_name]</a>"; //Prints the author name as a clickable link to the search feature, using the author_id as a parameter
